<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('automation-rules.index')" :active="request()->routeIs('automation-rules.index')">
                        {{ __('Automation Rules') }}
                    </x-nav-link>
                    <x-nav-link :href="route('connected-emails.index')" :active="request()->routeIs('connected-emails.index')">
                        {{ __('Connected Emails') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('automation-rules.index')" :active="request()->routeIs('automation-rules.index')">
                {{ __('Automation Rules') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('connected-emails.index')" :active="request()->routeIs('connected-emails.index')">
                {{ __('Connected Emails') }}
            </x-responsive-nav-link>
