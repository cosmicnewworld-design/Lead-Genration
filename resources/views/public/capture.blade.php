...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-6">Submit Your Information</h1>
            ...
            <form action="{{ route('public.capture.store', $tenant_slug) }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="job_title" id="job_title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
