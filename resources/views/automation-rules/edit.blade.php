        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="text-2xl font-semibold text-gray-700 mb-6">Edit Automation Rule: {{ $automationRule->name }}</h3>

                    <form action="{{ route('automation-rules.update', $automationRule) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('name', $automationRule->name) }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="trigger_source" id="trigger_source" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="lead" {{ $automationRule->trigger_source == 'lead' ? 'selected' : '' }}>Lead</option>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="trigger_event" id="trigger_event" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="created" {{ $automationRule->trigger_event == 'created' ? 'selected' : '' }}>Is Created</option>
                                <option value="updated" {{ $automationRule->trigger_event == 'updated' ? 'selected' : '' }}>Is Updated</option>
                                <option value="deleted" {{ $automationRule->trigger_event == 'deleted' ? 'selected' : '' }}>Is Deleted</option>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="action_type" id="action_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="send_email" {{ $automationRule->action_type == 'send_email' ? 'selected' : '' }}>Send Email</option>
                                <option value="add_tag" {{ $automationRule->action_type == 'add_tag' ? 'selected' : '' }}>Add Tag</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="action_data" id="action_data" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('action_data', $automationRule->action_data) }}</textarea>
