                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('leads.update', $lead) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="source" id="source" value="{{ $lead->source }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
